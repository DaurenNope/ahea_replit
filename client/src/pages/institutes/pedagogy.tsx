...
const PedagogyInstitutePage: React.FC = () => {
  ...
  // Primary color theme for Pedagogy Institute - green tones
  const primaryColor = 'from-green-700 to-green-900';
  const secondaryColor = 'bg-green-800';
    ...
    <Layout>
      ...
      <section className={`relative py-20 md:py-28 bg-gradient-to-br ${primaryColor} text-white overflow-hidden`}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            >
              {t('institutes.pedagogy.shortDescription')}
            </motion.p>
            ...
            >
              ...
              <a href="/programs?institute=pedagogy" className="bg-white text-green-800 hover:bg-gray-100 px-6 py-3 rounded font-medium transition-colors">
      ...
      <section id="about" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <SectionTitle 
            title={t('institutes.pedagogy.shortName')} 
            subtitle={t('institutes.pedagogy.description1')}
            centered={true}
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
            <div>
              <p className="text-lg text-aheu-neutral-darker mb-6">
                {t('institutes.pedagogy.description2')}
              </p>
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>{t('institutes.pedagogy.focusAreas.area1')}</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`mt-1 mr-3 w-4 h-4 rounded-full ${secondaryColor} flex-shrink-0`}></div>
                    <span>{t('institutes.pedagogy.focusAreas.area2')}</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`mt-1 mr-3 w-4 h-4 rounded-full ${secondaryColor} flex-shrink-0`}></div>
                    <span>{t('institutes.pedagogy.focusAreas.area3')}</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`mt-1 mr-3 w-4 h-4 rounded-full ${secondaryColor} flex-shrink-0`}></div>
                    <span>{t('institutes.pedagogy.focusAreas.area4')}</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`mt-1 mr-3 w-4 h-4 rounded-full ${secondaryColor} flex-shrink-0`}></div>
                    <span>{t('institutes.pedagogy.focusAreas.area5')}</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="relative rounded-xl overflow-hidden h-80 md:h-full">
              <img 
                src="/images/institutes/pedagogy-institute.jpg" 
                alt={t('institutes.pedagogy.imageAlt')} 
