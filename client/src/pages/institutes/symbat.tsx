...
const SymbatInstitutePage: React.FC = () => {
  ...
  // Primary color theme for Symbat Institute - orange/yellow tones
  const primaryColor = 'from-amber-500 to-orange-700';
  const secondaryColor = 'bg-orange-600';
    ...
    <Layout>
      ...
      <section className={`relative py-20 md:py-28 bg-gradient-to-br ${primaryColor} text-white overflow-hidden`}>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
            ...
            >
              {t('institutes.symbat.shortDescription')}
            </motion.p>
            ...
            >
              ...
              <a href="/programs?institute=symbat" className={`bg-white text-orange-700 hover:bg-gray-100 px-6 py-3 rounded font-medium transition-colors`}>
      ...
      <section id="about" className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <SectionTitle 
            title={t('institutes.symbat.shortName')} 
            subtitle={t('institutes.symbat.description1')}
            centered={true}
          />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mt-12">
            <div>
              <p className="text-lg text-aheu-neutral-darker mb-6">
                {t('institutes.symbat.description2')}
              </p>
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-2">
                  <li className="flex items-start">
                    ...
                    <span>{t('institutes.symbat.focusAreas.area1')}</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`mt-1 mr-3 w-4 h-4 rounded-full ${secondaryColor} flex-shrink-0`}></div>
                    <span>{t('institutes.symbat.focusAreas.area2')}</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`mt-1 mr-3 w-4 h-4 rounded-full ${secondaryColor} flex-shrink-0`}></div>
                    <span>{t('institutes.symbat.focusAreas.area3')}</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`mt-1 mr-3 w-4 h-4 rounded-full ${secondaryColor} flex-shrink-0`}></div>
                    <span>{t('institutes.symbat.focusAreas.area4')}</span>
                  </li>
                  <li className="flex items-start">
                    <div className={`mt-1 mr-3 w-4 h-4 rounded-full ${secondaryColor} flex-shrink-0`}></div>
                    <span>{t('institutes.symbat.focusAreas.area5')}</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="relative rounded-xl overflow-hidden h-80 md:h-full">
              <img 
                src="/images/institutes/symbat-institute.jpg" 
                alt={t('institutes.symbat.imageAlt')} 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-5xl mx-auto">
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-2">9</h3>
            ...
            <div className="bg-white rounded-lg p-6 text-center shadow-sm">
              ...
              <h3 className="text-xl font-semibold mb-2">1,800+</h3>
