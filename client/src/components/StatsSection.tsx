      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            ...
            <div className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary mb-4">9000+</div>
            
            <p className="text-center text-sm md:text-base text-aheu-neutral-darker px-2 md:px-4 max-w-xs mx-auto">
              {t('stats.students.text', 'Студентов')}
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary mb-4">350+</div>
            
            <p className="text-center text-sm md:text-base text-aheu-neutral-darker px-2 md:px-4 max-w-xs mx-auto">
              {t('stats.faculty.text', 'Преподавателей и исследователей')}
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary mb-4">39</div>
            
            <p className="text-center text-sm md:text-base text-aheu-neutral-darker px-2 md:px-4 max-w-xs mx-auto">
              {t('stats.programs.text', 'Образовательных программ')}
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary mb-4">95%</div>
            
            <p className="text-center text-sm md:text-base text-aheu-neutral-darker px-2 md:px-4 max-w-xs mx-auto">
              {t('stats.employment.text', 'Уровень трудоустройства выпускников спустя полгода после окончания университета')}
            </p>
          </motion.div>
        </motion.div>
      </div>
